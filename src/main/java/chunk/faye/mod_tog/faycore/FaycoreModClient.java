...
public class FaycoreModClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        net.fabricmc.fabric.api.client.event.lifecycle.v1.ClientTickEvents.END_CLIENT_TICK.register(client -> {
            ...
            int currentG = chunk.faye.mod_tog.faycore.client.gui.FayCoreMacroEngine.selectedGroupIndex;
            boolean isChannelEnabled = chunk.faye.mod_tog.faycore.client.gui.FayCoreMacroEngine.groupEnables.get(currentG);
            ...
            int curGroupMode = chunk.faye.mod_tog.faycore.client.gui.FayCoreMacroEngine.groupModes.get(chunk.faye.mod_tog.faycore.client.gui.FayCoreMacroEngine.selectedGroupIndex);

            boolean shouldClockRun = false;
            try {
                for (int g = 0; g != 10; g++) {
                    if (chunk.faye.mod_tog.faycore.client.gui.FayCoreMacroEngine.groupModes.get(g) == 2 && chunk.faye.mod_tog.faycore.client.gui.FayCoreMacroEngine.groupEnables.get(g)) {
                        if (chunk.faye.mod_tog.faycore.client.gui.FaycoreSettingsScreen.posA != null && chunk.faye.mod_tog.faycore.client.gui.FaycoreSettingsScreen.posB != null) {
                            shouldClockRun = true;
                        }
                    }
                }
            ...
            if (curGroupMode == 1) {
                if (isHPressed)
                    chunk.faye.mod_tog.faycore.client.gui.FayCoreMacroEngine.isMacroRunning = true;
            } else if (curGroupMode == 0) {
                if (isHPressed) {
                    if (!chunk.faye.mod_tog.faycore.client.gui.FayCoreMacroEngine.isSingleTriggerLocked && !client.player.isSpectator()) {
                        if (!chunk.faye.mod_tog.faycore.client.gui.FayCoreMacroEngine.isMacroRunning) {
                            chunk.faye.mod_tog.faycore.client.gui.FayCoreMacroEngine.isMacroRunning = true;
                            chunk.faye.mod_tog.faycore.client.gui.FayCoreMacroEngine.isSingleTriggerLocked = true;
                        }
                    }
                } else {
                    chunk.faye.mod_tog.faycore.client.gui.FayCoreMacroEngine.isSingleTriggerLocked = false;
                }
            }
            if (chunk.faye.mod_tog.faycore.client.gui.FayCoreMacroEngine.isMacroRunning || shouldClockRun) {
                chunk.faye.mod_tog.faycore.client.gui.FayCoreMacroEngine.executeMacroEngineCore();
            }
        });
            ...
            if (rawText.equalsIgnoreCase("faycoremacro") || rawText.equalsIgnoreCase("/faycoremacro")) {
                ...
                mc.execute(() -> {
                    if (mc.player != null) {
                        ...
                        mc.setScreen(new chunk.faye.mod_tog.faycore.client.gui.FayCoreMacroScreen());
                    }
                });
                return false;
            }
                        ...
                        mc.execute(() -> {
                            if (mc.player != null && mc.level != null) {
                                try {
                                    ...
                                    chunk.faye.mod_tog.faycore.world.inventory.FaycoreSettingsMenu menu = new chunk.faye.mod_tog.faycore.world.inventory.FaycoreSettingsMenu(0, player.getInventory(), (net.minecraft.world.Container) null);
                                    mc.setScreen(new chunk.faye.mod_tog.faycore.client.gui.FaycoreSettingsScreen(menu, player.getInventory(), net.minecraft.network.chat.Component.literal("FayCore 選區配置")));
                                } catch (Exception ex) {
    ...
    public static void renderNativeFayCoreHUD(net.minecraft.client.gui.GuiGraphicsExtractor guiGraphics) {
        if (guiGraphics == null)
            return;
        if (chunk.faye.mod_tog.faycore.client.gui.FaycoreSettingsScreen.fillStage == 2) {
            hudDisplayTickCooldown = 35;
            chunk.faye.mod_tog.faycore.client.gui.FaycoreSettingsScreen.fillStage = 0;
        }
        if (hudDisplayTickCooldown > 0) {
            net.minecraft.client.Minecraft mc = net.minecraft.client.Minecraft.getInstance();
            if (mc.player == null || mc.level == null)
                return;
            net.minecraft.core.BlockPos pA = chunk.faye.mod_tog.faycore.client.gui.FaycoreSettingsScreen.posA;
            net.minecraft.core.BlockPos pB = chunk.faye.mod_tog.faycore.client.gui.FaycoreSettingsScreen.posB;
            if (pA != null && pB != null) {
